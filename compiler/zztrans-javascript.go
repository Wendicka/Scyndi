...
func init(){
	...
	mkl.Version("Scyndi Programming Language - zztrans-javascript.go","18.10.24")
	var tmw *T_TransMod;
	forNode:=&T_TransMod {}
	forNWJS:=&T_TransMod {}
	forSite:=&T_TransMod {}
	...
	// saving and bundling
	saveprogram:=func(s *tsource,translation,outp string){
	...
	forNode.savetrans=func(s *tsource,translation,outp string){
		...
		saveprogram(s,translation,outp);
	}
}
